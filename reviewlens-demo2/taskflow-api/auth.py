"""
TaskFlow API — session/token validation helpers.

Tokens are simple Bearer strings in this demo.
Format: "tf_<user_id>_<secret>"
Example: "tf_user_001_dev-secret-change-in-production"
"""
...
def _parse_token(token: str) -> tuple[str, str]:
    """Split a TaskFlow token into (user_id, secret) parts."""
